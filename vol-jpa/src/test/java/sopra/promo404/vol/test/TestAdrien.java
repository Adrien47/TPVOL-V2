...
public class TestAdrien {
	...
	public static void main(String[] args) {
		...
		compAerVol1.setCompagnieAerienne(compAer1);
//		compAerVol1.setId(123L);
		compAerVol1.setNumero("ADC");

		
		compAer1.getVols().add(compAerVol1);
		compAer1.getVols().add(compAerVol2);
		compAer1.getVols().add(compAerVol3);
